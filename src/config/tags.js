...
const BLACKLIST_TAGS = new Set([
  ...
  'dramatic lighting', 'dramatic light','umbrella',
  'cinematic lighting', 'cinematic light','waves',
  ...
  'bird eye view', 'top view', 'top down', 'aerial view','funny',
  ...
  'no text', 'without text', 'text free', 'no logo','glass',
