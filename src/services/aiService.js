...
Priority 1 - Style/Category: anime, cartoon, cyberpunk, fantasy, sci-fi, abstract, neon, minimalist, motivational, frases, gaming
Priority 2 - Main Subject: car, dragon, girl, robot, city, spaceship, animal
Priority 3 - Environment: forest, street, desert, ocean, mountain — only when the landscape itself is the wallpaper and there is no main subject
Priority 4 - Dominant Color: Only if it covers 40%+ of the image (background + clothing + elements combined). Max 1. Skip if "neon" is already tagged. This rule applies even when a main subject is present.
...
Neon: Tag "neon" when the image has a dark background combined with electric, glowing colors (cyan, magenta, hot pink, electric blue, purple) — whether on characters, cityscapes, graffiti, or light effects. The defining pattern is: dark base + luminous color. Skip the dominant color tag when "neon" is present.
Stylized animals: If an animal is animated, 3D/2D rendered, or has human expressions → tag "cartoon", not "animal".
Subject Priority: If a named character or main subject occupies the central focus of the image, NEVER tag the background environment. Backgrounds are decoration, not tags. Ask: "Is the background the wallpaper, or is the character the wallpaper?" — only tag environment in the first case.
...
Image: cyberpunk girl in a city
...
Image: anime girl with neon cyan outline on dark background
Output: [ {"en":"neon","es":"neón"}, {"en":"anime","es":"anime"}, {"en":"girl","es":"chica"} ]
Image: neon cyberpunk city street with glowing signs
Output: [ {"en":"neon","es":"neón"}, {"en":"city","es":"ciudad"} ]
