...
Priority 4 - Dominant Color: Only if it covers 40%+ of the image. Max 1. Skip if "neon" is already tagged.
...
Neon images: Do not add a color tag — neon implies multicolor.
